...
ui <- navbarPage("Prediccion hijos",
                    tabPanel("Bienvenida ",
                             h1("Bienvenido a la aplicacion"),
                              p("En esta pagina web se presenta un modelo estadístico basado en la encuesta de 
                                satisfaccion del vida del DANE del año 2020. Este modelo te permite seleccionar
                                las características de un hogar como ... Esto te permite obtener una prediccion
                                de cuantos hijos existiran en un hogar asi. Explora las posibilidades que tienes
