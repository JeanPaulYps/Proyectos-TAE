...
```{r}
# Imprime el porcentaje de transacciones hechas por las primeras 50 personas
...
```{r}
# Prueba para analizar otros aspectos de los mejores clientes 
mejoresTransacciones <- inner_join(datos, clientesConTransaccionesDeEntradaMasValiosos, by=c("nit" = "nit"))
mejoresTransacciones
```

```{r}
# Prueba para analizar el ciclo financiero de los mejores clientes del ticket de entrada 
