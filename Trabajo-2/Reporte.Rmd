...
Para la ejecución del presente informe, se requiere del análisis de una base de datos con información de los clientes de una empresa; también se requiere la minería de datos para aplicar acertivamente una técnica de segmentación que permita reconocer comportamientos y tendencias entre los distintos grupos. para esto se usará el lenguaje de programación R, en su entorno de desarrollo integrado R STUDIO con el uso de las tecnologías de la información y de las comunicaciones. 
...
A continuación, se presentan cuatro (4) variables que son de tipo númericas, pero que también son descritas dentro de las variables de caracter financiero en este trabajo. que describen en gran parte la parte financiera de la empresa en el estado de flujo de efectivo. 
...
A continuación se presenta una comparación directa con las variables que influyen en los estados financieros de la compañía y los valores que se representan númericamente con los tickets y las transacciones.
...
* Las mejores categorias en todas las cuentas de cobrar o pagar son la categoria número 6, teniendo en cuenta que corresponde a categorias de ordinales, supone que a mayor número mejor para la compañía y esto lo apoya la frecuencia con los clientes y los diferentes porcentajes de transacciones y de tickets que se compararon. 
...
* Parece no existir diferencia significativa entre los puntos de ventas fisicos o electronicos, de acuerdo con cada una de las variables categóricas analizadas.

* De las variables categóricas el grupo de empresas que pertenen al 80% que más contribuye en las trabsacciones por tickets de salida es el que mejor resultados ofrece y que mayor valor brinda a las finanzas de la empresa.

* El valor total de inventarios de categoria 6 presenta el mayor número de empresas en comparación con las otras 5 categorías. En esta se concentran los clientes cuyo valor por inventarios es el mayor, es decir aquellas empresas de mayor tamaño según esta variable. 

* Más de la mitad de las empresas en el 80% que más aporta por tickets de salida presenta valores mayores al 50% para el nivel de rotación de cuentas por pagar en las categorias 1 y 2. Esto sugiere que dichas empresas son buenos clientes dado que responden a saldar deuda adquirida con otras empresas dentro de plazos de tiempo cortos.
...
#  Analisis de resultados segmentacion jerarquica
...
que se vende finalmente el producto final y el pago es recibido por la empresa.Como
distintas variables financieras que explican la información. 
